...
def create_mask(src: Tensor, tgt: Tensor) -> Tuple[Tensor, Tensor, Tensor, Tensor]:
    ...
    :param src: batch of indices of tokens [Tx, B]
    :param tgt: batch of indicies of tokens [Ty, B]
    :return src_mask: torch.bool [Tx, Tx]
    :return tgt_mask: torch.bool [Ty, Ty]
    :return src_padding_mask: torch.bool [B, Tx]
    :return tgt_padding_mask: torch.bool [B, Ty]
    """
    src_seq_len = src.shape[0]  # Tx
    tgt_seq_len = tgt.shape[0]  # Ty
