...
def loop_through_usl_hdb_and_pass_data_through_mdl():
    ...
    '''
    for dataloaders in [fungi_usl_all_splits_dataloaders(args)]: #dtd_usl_all_splits_dataloaders(args), cu_birds_usl_all_splits_dataloaders(args), fc100_usl_all_splits_dataloaders(args),
